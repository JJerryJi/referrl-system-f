...
import { Grid, Container, Typography, Stack, Button, TablePagination, Table, TableContainer, TableHead } from '@mui/material';
  ...
  return (
    <>
      ...
      <Container maxWidth="xl">
        ...
        <Button onClick={handlePopularitySort} sx={{ marginRight: '10%' }} > Order by Popularity </Button>
